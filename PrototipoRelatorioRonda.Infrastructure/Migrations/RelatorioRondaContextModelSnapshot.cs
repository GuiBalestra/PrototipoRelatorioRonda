...
namespace PrototipoRelatorioRonda.Infrastructure.Migrations
{
    ...
    partial class RelatorioRondaContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PrototipoRelatorioRonda.Domain.Entities.Empresa", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PrototipoRelatorioRonda.Domain.Entities.RelatorioRonda", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PrototipoRelatorioRonda.Domain.Entities.Usuario", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PrototipoRelatorioRonda.Domain.Entities.VoltaRonda", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PrototipoRelatorioRonda.Domain.Entities.RelatorioRonda", b =>
                {
                    b.HasOne("PrototipoRelatorioRonda.Domain.Entities.Empresa", "Empresa")
                        .WithMany()
                        .HasForeignKey("EmpresaId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("PrototipoRelatorioRonda.Domain.Entities.Usuario", "Vigilante")
                        .WithMany()
            ...
            modelBuilder.Entity("PrototipoRelatorioRonda.Domain.Entities.VoltaRonda", b =>
                {
                    b.HasOne("PrototipoRelatorioRonda.Domain.Entities.RelatorioRonda", "RelatorioRonda")
                        .WithMany("Voltas")
